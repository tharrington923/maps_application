...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> degreeValues = new ArrayList<Integer>();
		int numNeighbors;
		int numInNeighbors;
		for(int i = 0; i < numVertices; i++){
			numNeighbors = getNeighbors(i).size();
			numInNeighbors = getInNeighbors(i).size();
			degreeValues.add(numNeighbors+numInNeighbors);
		}
		Collections.sort(degreeValues,Collections.reverseOrder());
		return degreeValues;
	}
